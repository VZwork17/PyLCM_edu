...
################################
    ...
    for t in range(nt):
        ...
        # Parcel ascending with support for turbulent mode
        z_parcel, T_parcel, P_parcel, wp_parcel, dz_parcel = ascend_parcel(
            z_parcel, T_parcel, P_parcel, w_parcel, wp_parcel, dt, time, max_z, theta_profiles,
            time_half_wave_parcel=time_half_wave_parcel, ascending_mode=ascending_mode,
            tau_corr=tau_corr, noise_amplitude=noise_amplitude, rng=rng
        )
        
        # Store perturbation velocity
